...
import { createTipoActivo } from "@/lib/actions/tipos-activos"
...
export function NuevoTipoActivoModal({ open, onOpenChange, onSuccess }: Props) {
      ...
      <DialogContent className="bg-gray-800 border-gray-700 text-white max-w-md">
        <DialogHeader>
          <DialogTitle className="flex items-center space-x-2">
            ...
            <span>Nuevo Tipo de Activo</span>
          </DialogTitle>
        </DialogHeader>
